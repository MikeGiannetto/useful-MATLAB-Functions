...
% Edited 2/15/2023
%{
"Parent folder" should be a folder containing multiple folders saved from
thorlabs 2P with images saved as individual .tif files.
...
%Create 8bit version of file
capNrml = capillary(:,:,1) ./ max(capillary(:,:,1),[],'all');
capillary8 = uint8(capNrml);
